...
const CookiePolicyPage = () => {
  return (
    <div className="cookiepolicypage">
      <Header
        helpCenterIconsvg="/helpcentericonsvg1@2x.png"
        headerCartIconsvg="/headercarticonsvg1@2x.png"
      />
      <div className="cookie-policy-wrapper">
        <h1 className="cookie-policy">Cookie Policy</h1>
      </div>
      <main className="cookie-policy-intro">
        ...
        <div className="what-are-cookies-parent">
          ...
          <div className="how-we-use-cookies-title-parent">
            <div className="how-we-use-cookies-title">
            ...
            <div className="cookie-type-descriptions">
        ...
        <div className="cookie-setting-titles">
        ...
        <div className="managing-cookies-parent">
          ...
          <div className="logo-and-description-parent">
            ...
            <div className="logo-and-description1">
            ...
            <div className="logo-and-description2">
